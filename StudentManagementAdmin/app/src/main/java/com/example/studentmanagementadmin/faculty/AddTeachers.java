...
public class AddTeachers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category","Computer Science & Technology", "Civil Engineering", "Mechanical Engineering", "Electrical Engineering","Survey Engineering","Science & Humanities", "Electronics & Tele-Communication"};
